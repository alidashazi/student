...
<head>
    ...
    <link href="${pageContext.request.contextPath}/h-ui/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/h-ui/lib/icheck/jquery.icheck.min.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "cpacha?v1=4&w=150&h=40&method=GetVcode&t=" + new Date().getTime();
            });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if ("success" == data.type) {
                            ...
                            //changed
                            $.messager.alert("登录提醒", data.msg||"未知的返回消息", "warning");
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    <input class="input-text size-L" name="vcode" type="text" placeholder="请输入验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码" id="vcodeImg" src="cpacha?v1=4&w=150&h=40&method=GetVCode"></div>
            </div>
...
<div class="footer">Copyright &nbsp; BILL @ BAIZHI</div>
