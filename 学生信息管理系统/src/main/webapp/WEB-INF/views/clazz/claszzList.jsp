        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'clazzId', title: '年级名', width: 150, sortable: true},
            ...
            <tr>
                ...
                <td>
                    <input id="add_name" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="name" data-options="required:true, missingMessage:'请填写班级名'"/>
                </td>
            </tr>
            <tr>
                <td>年级名:</td>
            ...
            <tr>
                ...
                <td>
                    <input id="edit_name" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="name" data-options="required:true, missingMessage:'请填写年级名'"/>
                </td>
            </tr>
            <tr>
                <td>备注:</td>
